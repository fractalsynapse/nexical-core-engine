...
class Provider(BaseProvider("qdrant_collection", "team_document")):
    ...
    def _get_document_id_filters(
        self, team_id=None, collection_id=None, document_id=None
    ):
    ...
    def store(
        self, team_id, collection_id, document_id, sentence, embedding, topics, order
    ):
    ...
    def remove(self, team_id=None, collection_id=None, document_id=None):
        return self.request_delete(
            collection_name=self.name,
            points_selector=self._get_document_id_filters(
                team_id, collection_id, document_id
            ),
        )
